package com.prem.alarmapp.notification
...
class AlarmNotificationHelper(base: Context) : ContextWrapper(base) {
    ...
    private val MYCHANNEL_ID = "Alarm Notification ChannelID"
    private val MYCHANNEL_NAME = "My Alarm"
    ...
    private fun stopAlarmTone(context: Context): PendingIntent {
        ...
        return PendingIntent.getService(
            this, notificationId, stopAlarmIntent,
